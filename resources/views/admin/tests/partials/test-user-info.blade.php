        ...
        <form method="POST" action="{{ route("admin.tests.update", [$test->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @can('centre_edit')
                    <select name="centre_id" id="centre_id" required
                            class="form-control select2 {{ $errors->has('centre') ? 'is-invalid' : '' }}">
                        @foreach($centres as $id => $entry)
                            <option
                                value="{{ $id }}" {{ old('centre_id', $test->centre_id) == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                <label class="required"
                       for="reservation_id_ref">{{ trans('cruds.test.fields.reservation_id_ref') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text"
                       name="firstname" id="firstname" value="{{ old('firstname', $test->firstname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lastname') ? 'is-invalid' : '' }}" type="text"
                       name="lastname" id="lastname" value="{{ old('lastname', $test->lastname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email"
                       id="email" value="{{ old('email', $test->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone"
                       id="phone" value="{{ old('phone', $test->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob"
                       id="dob" value="{{ old('dob', $test->dob) }}" required>
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pinrc') ? 'is-invalid' : '' }}" type="text" name="pinrc"
                       id="pinrc" value="{{ old('pinrc', $test->pinrc) }}">
                @if($errors->has('pinrc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('pinrc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pinid') ? 'is-invalid' : '' }}" type="text" name="pinid"
                       id="pinid" value="{{ old('pinid', $test->pinid) }}" required>
                @if($errors->has('pinid'))
                    <div class="invalid-feedback">
                        {{ $errors->first('pinid') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street') ? 'is-invalid' : '' }}" type="text" name="street"
                       id="street" value="{{ old('street', $test->street) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city"
                       id="city" value="{{ old('city', $test->city) }}" required>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postal') ? 'is-invalid' : '' }}" type="text" name="postal"
                       id="postal" value="{{ old('postal', $test->postal) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country"
                       id="country" value="{{ old('country', $test->country) }}" required>
            ...
            <div class="form-group">
                <input type="hidden" name="redirect_back" value="{{ old('redirect_back', url()->previous('admin.tests.index')) }}" />
                <a class="btn btn-outline-info" href="{{ old('redirect_back', url()->previous('admin.tests.index')) }}">
                    {{ trans('global.back') }}
                </a>
