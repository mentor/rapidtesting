            ...
            <div class="row justify-content-center">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('firstname') ? 'is-invalid' : '' }}" type="text"
                               name="firstname" id="firstname" value="{{ old('firstname', $test->firstname) }}"
                               required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('pinrc') ? 'is-invalid' : '' }}" type="text"
                               name="pinrc"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('pinid') ? 'is-invalid' : '' }}" type="text"
                               name="pinid"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('postal') ? 'is-invalid' : '' }}" type="text"
                               name="postal"
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div
                            class="font-weight-bold text-uppercase">{{ App\Models\Test::STATUS_SELECT[$test->status] }}</div>
