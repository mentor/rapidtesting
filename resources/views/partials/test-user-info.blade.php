<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <select disabled class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
        ...
        <div class="form-group">
            ...
            <select disabled class="form-control select2 {{ $errors->has('service') ? 'is-invalid' : '' }}" name="service_id" id="service_id" required>
        ...
        <div class="form-group">
            ...
            <input disabled class="form-control datetime {{ $errors->has('start') ? 'is-invalid' : '' }}" type="text" name="start" id="start" value="{{ old('start', $test->start) }}">
            @if($errors->has('start'))
                <div class="invalid-feedback">
                    {{ $errors->first('start') }}
                </div>
        ...
        <div class="form-group">
            ...
            <input disabled class="form-control datetime {{ $errors->has('end') ? 'is-invalid' : '' }}" type="text" name="end" id="end" value="{{ old('end', $test->end) }}">
            @if($errors->has('end'))
                <div class="invalid-feedback">
                    {{ $errors->first('end') }}
                </div>
        ...
        <div class="form-group">
            ...
            <select disabled class="form-control select2 {{ $errors->has('centre') ? 'is-invalid' : '' }}" name="centre_id" id="centre_id" required>
        ...
        <div class="form-group">
            ...
            <input disabled class="form-control {{ $errors->has('reservation_id_ref') ? 'is-invalid' : '' }}" type="number" name="reservation_id_ref" id="reservation_id_ref" value="{{ old('reservation_id_ref', $test->reservation_id_ref) }}" step="1" required>
        ...
        <div class="form-group">
            ...
            <input disabled class="form-control {{ $errors->has('code_ref') ? 'is-invalid' : '' }}" type="text" name="code_ref" id="code_ref" value="{{ old('code_ref', $test->code_ref) }}" required>
